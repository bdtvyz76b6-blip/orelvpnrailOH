...
def calculate_subscription_date(
    ...
    # По умолчанию начинаем от сегодняшнего дня
    start_date = now
    ...
    if current_until:
        ...
        try:
            ...
            # Если старая подписка ещё действует
            # до конца сегодняшнего дня,
            # продолжаем от её даты.
    ...
    # превращаем в максимальную дату.
...
def check_user_subscription(
    ...
    try:
        ...
        # ВАЖНО:
        # день окончания считается активным.
        #
        # Например:
        # 18.08.2026 = активно весь день 18 августа.
        #
        # Отключится только 19 августа.
