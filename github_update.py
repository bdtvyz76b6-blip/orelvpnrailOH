...
Поддержка скрытия/блокировки редактирования зависит от VPN-клиента.
...
СЕРВЕРА ДЛЯ ОТКЛЮЧЁННОЙ ПОДПИСКИ
...
print("━━━━━━━━━━━━━━━━━━━━━━━━━━")
# Даём приложению время запустить базу данных.
time.sleep(15)
while True:
    try:
