...
async def get_link(
    ...
    #
    # ВАЖНО:
    # Crypt4-ссылка здесь НЕ показывается.
    # ========================================================

    text = """
⚡ <b>Подключение ixxy VPN</b>

🔐 <b>Защищённая подписка готова</b>

Выберите удобный способ подключения:

⚡ <b>Happ</b>
Автоматическое подключение через Happ.

🌐 <b>ixxy VPN</b>
Открытие персональной страницы подписки.

📋 <b>Crypt4</b>
Получить защищённую ссылку для ручного подключения.
